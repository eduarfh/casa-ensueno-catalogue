...
function ProductCard({ id, name, price, images = [], available = true, categories }) {
    ...
    const productUrl = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/product/${id}` : "TURBOPACK unreachable";
    const handleShare = async ()=>{
        ...
        try {
            ...
            if (typeof navigator !== "undefined" && navigator.share) {
                ...
                toast({
                    title: "Abrir",
                    description: "Abriendo el producto en una nueva pestaña."
                });
    ...
    const handleWhatsApp = ()=>{
        ...
        if ("TURBOPACK compile-time truthy", 1) window.open(whatsappUrl, "_blank");
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductCard.useEffect": ()=>{
            const handler = {
                "ProductCard.useEffect.handler": (ev)=>{
            ...
            }["ProductCard.useEffect.handler"];
            window.addEventListener("keydown", handler);
            return ({
                "ProductCard.useEffect": ()=>window.removeEventListener("keydown", handler)
            })["ProductCard.useEffect"];
        }
    }["ProductCard.useEffect"], [
        imgs.length
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductCard.useEffect": ()=>{
            ...
            let dx = 0;
            const onPointerDown = {
                "ProductCard.useEffect.onPointerDown": (e)=>{
                    startX = e.clientX;
                    try {
            ...
            }["ProductCard.useEffect.onPointerDown"];
            const onPointerMove = {
                "ProductCard.useEffect.onPointerMove": (e)=>{
                    dx = e.clientX - startX;
                }
            }["ProductCard.useEffect.onPointerMove"];
            const onPointerUp = {
                "ProductCard.useEffect.onPointerUp": ()=>{
                    if (Math.abs(dx) > 40) {
                        if (dx < 0) setIndex({
                            "ProductCard.useEffect.onPointerUp": (i)=>(i + 1) % imgs.length
                        }["ProductCard.useEffect.onPointerUp"]);
                        else setIndex({
                            "ProductCard.useEffect.onPointerUp": (i)=>(i - 1 + imgs.length) % imgs.length
                        }["ProductCard.useEffect.onPointerUp"]);
                    }
                    dx = 0;
                }
...
_s(ProductCard, "SKNIUi27d+jhhVTNkuON0Ri/1KY=", false, function() {
    return [
...
//# sourceMappingURL=_f00ceafd._.js.map